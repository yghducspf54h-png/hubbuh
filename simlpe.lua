...
-- Function Info keeps its generated text separately so Copy Code always
-- copies the complete report, even when the codebox renderer has stale text.
local functionInfoClipboard = nil

newButton(
    "Copy Code",
    function() return "Click to copy code" end,
    function()
        setclipboard(functionInfoClipboard or codebox:getString())
...
function()
    ...
    if func then
        ...
        functionInfoClipboard = "-- Calling function info\n-- Generated by the SimpleSpy V3 serializer\n\n"..selected.Function
        codebox:setRaw(functionInfoClipboard)
